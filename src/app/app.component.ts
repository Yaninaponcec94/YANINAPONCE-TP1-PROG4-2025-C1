...
export class AppComponent {
  ...
  /** ✅ Este método agrupa TODAS las páginas sin layout */
  isPaginaSinLayout(): boolean {
    const sinLayout = ['/login', '/registro', '/ahorcado', '/mayor-menor', '/historial'];
    return sinLayout.includes(this.router.url);
  }
...
export class AppComponent {
  ...
  isJuegoPage():boolean{
    return this.router.url ==='/ahorcado' || this.router.url === '/mayor-menor'; 
  }
}
